import { mbtiQuestions, mbtiResults, type MbtiQuestion, type MbtiResult, type InsertMbtiResult } from "@shared/schema";
  ...
  private initializeMbtiQuestions() {
    this.mbtiQuestions = [
      ...
      },
      {
        ...
        category: "E/I",
        options: [
          { value: "E3", text: "친구들과 대화하며 해소한다", description: "타인과의 소통을 통해 에너지를 얻는다", dimension: "E" },
          { value: "I4", text: "혼자만의 시간을 가지며 생각한다", description: "내적 성찰을 통해 문제를 해결한다", dimension: "I" },
          { value: "E4", text: "활동적인 일을 하며 기분전환한다", description: "외부 활동을 통해 스트레스를 해소한다", dimension: "E" },
          { value: "I5", text: "조용한 곳에서 휴식을 취한다", description: "평온한 환경에서 재충전한다", dimension: "I" }
        ]
      },
      {
        id: 6,
      ...
      },
      {
        ...
        options: [
          { value: "E5", text: "적극적으로 의견을 제시하고 토론한다", description: "활발한 의사소통을 통해 아이디어를 발전시킨다", dimension: "E" },
          { value: "I6", text: "충분히 생각한 후 신중하게 발언한다", description: "깊이 있는 사고를 통해 질 높은 의견을 제시한다", dimension: "I" },
          { value: "E6", text: "팀원들과의 협력을 즐긴다", description: "집단 작업의 역동성과 시너지를 추구한다", dimension: "E" },
          { value: "I7", text: "개별 과제를 선호한다", description: "독립적이고 집중적인 작업을 통해 기여한다", dimension: "I" }
        ]
      },
      {
        id: 10,
